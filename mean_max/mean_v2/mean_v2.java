...
public class mean_v2 {
    ...
    public static class meanReducer 
        ...
        public void reduce(Text key, Iterable<MapWritable> values, Context context) throws IOException, InterruptedException {
            ...
            for (MapWritable val: values) {
                ...
                cnt += Integer.valueOf(val.get(new Text("sum")).toString());
            }
    ...
    public static class meanCombiner
        extends Reducer<Text,DoubleWritable,Text,MapWritable> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf,"mean_v2");
        job.setJarByClass(mean_v2.class);
